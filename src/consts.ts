...
export const DESCRICAO_SITE = "Portfólio de Brenno Alves — dados, automação e gestão de projetos de desenvolvimento.";
...
export const projetosDestaque = Object.entries(projetos).filter(([, p]) => p.destaque);
